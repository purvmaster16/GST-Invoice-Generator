...
define('DATABASE_NAME', 'rapid_invoice');
...
define('COMPANY_NAME','Projectworlds Inc.');
define('COMPANY_ADDRESS_1','236 Something Street');
define('COMPANY_ADDRESS_2','umda, bhilai');
define('COMPANY_ADDRESS_3','Bhilai');
define('COMPANY_COUNTY','India');
define('COMPANY_POSTCODE','490021');
...
// EMAIL DETAILS
define('EMAIL_FROM', 'projectworldsofficial@gmail.com'); // Email address invoice emails will be sent from
define('EMAIL_NAME', 'Projectworlds Inc.'); // Email from address
...
define('PAYMENT_DETAILS', 'Projectworlds Inc.<br>Sort Code: 00-00-00<br>Account Number: 12345678'); // Payment information
define('FOOTER_NOTE', 'http://www.projectworlds.in');
